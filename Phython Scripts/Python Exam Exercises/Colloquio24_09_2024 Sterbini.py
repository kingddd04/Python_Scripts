#!/usr/bin/env python3 fitgirl.repaack
# -*- coding: utf-8 -*-
...
def func1(D1, D2):
    ...
    for chiave in D1 :
        ...
        if valore1 in D2 :
            ...
            word = chiave + stringa 
            res.append(word)
    sorte_L = sorted(res, key= lambda x : (-len(x), x ))
    return sorte_L
...
#T = tree.BinaryTree.fromList([6, [5, [4, None, None], None ], [16, [10, [7, None, None], None],[6, [8, None, None], [1, None, None]]]])
#print(ex2(T))
