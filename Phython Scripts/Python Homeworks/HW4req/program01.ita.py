...
cartella_da_creare = "testx"

# Ottieni il percorso della cartella corrente
percorso_corrente = os.getcwd()

# Unisci il percorso corrente con il nome della cartella
percorso_cartella = os.path.join(percorso_corrente, cartella_da_creare)

# Utilizza os.makedirs() per creare la cartella
